...
Version: ${_VERSION}
Architecture: ${_ARCH}
Maintainer: @Keshavah-reddy
Depends: ${_depend}
Homepage: https://github.com/Keshavah-reddy/Meow
Description: An automated phishing tool with 34 templates. This Tool is made for educational purpose only !
CONTROL_EOF
...
cp -fr .github/ .sites/ LICENSE README.md Meow.sh ./build_env/$_opt_dir
